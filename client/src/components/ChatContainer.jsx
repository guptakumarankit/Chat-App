...
const ChatContainer = () => {
  ...
  return selectedUser ? (
    <div className="h-full overflow-scroll relative backdrop-blur-lg">
        ...
        {messages.map((msg, index) => (
          ...
          >
            {msg.image ? (
              ...
              <p
                className={`p-2 max-w-[200] md:text-sm font-light rounded-lg mb-8 break-all bg-violet-500/30 text-white ${
      ...
      {/* ------- bottom area --------- */}
      <div className="max-h-[10%] absolute left-0 right-0 bottom-0 flex  items-center gap-3 p-3">
